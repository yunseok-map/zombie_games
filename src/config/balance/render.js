...
export const FX = {
  ...
  ambientColor: 0x6a7a86,  // 실내 기본. 구역이 ambientColor 를 주면 그때만 바뀐다

  /**
   * ── 달빛 (2026-08-08) ──
   * 옥상만 쓴다. 실내에서는 세기 0 이라 없는 것과 같다 (Atmosphere.moon 주석 참고).
   * 방향은 정규화하지 않아도 된다 — three 는 위치에서 target 을 향하는 방향만 본다.
   * 낮게 비스듬히 들어와야 난간과 실외기의 그림자 대신 **형태의 결**이 살아난다.
   */
  moonColor: 0x9fb6d4,     // 푸른 기가 도는 흰색. 순백이면 형광등처럼 보인다
  moonDir: [-6, 9, -4],    // 왼쪽 위 뒤에서
