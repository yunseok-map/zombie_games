...
export const ANIM = {
   ...
   *
   * **0.40(moveMinSpeed) 밑으로 내리지 마라** — `crawlerHitSpeed` 와 같은 이유다.
   * 0.35 로 두고 지터(0.85~1.15)를 곱하던 시절에는 개체 대부분이 하한을 밑돌아,
   * 배회 중 멈춘 포복체가 **x0.30 슬로모션**으로 90프레임 잡혔다 (2026-08-09).
   * 지금은 멈춘 동안 지터를 안 곱하고, 그 위에 clamp 도 걸려 있다.
   */
  crawlerIdleSpeed: 0.42,
